...
namespace CocCanService.Services.Imp
{
    public class LocationService:ILocationService
    {
        ...
        public Task<ServiceResponse<LocationDTO>> CreateLocationAsync(CreateLocationDTO createLocationDTO)
        {
            throw new NotImplementedException();
        }

        public Task<ServiceResponse<List<LocationDTO>>> GetAllLocationsAsync()
        {
            throw new NotImplementedException();
        }

        public Task<ServiceResponse<LocationDTO>> GetLocationByIdAsync(Guid id)
        {
            throw new NotImplementedException();
        }

        public Task<ServiceResponse<string>> SoftDeleteLocationAsync(Guid id)
        {
            throw new NotImplementedException();
        }

        public Task<ServiceResponse<LocationDTO>> UpdateLocationAsync(LocationDTO locationDTO)
        {
            throw new NotImplementedException();
        }
