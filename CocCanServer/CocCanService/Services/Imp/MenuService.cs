...
namespace CocCanService.Services.Imp
{
    public class MenuService: IMenuService
    {
        ...
        public Task<ServiceResponse<MenuDTO>> CreateMenuAsync(CreateMenuDTO createMenuDTO)
        {
            throw new NotImplementedException();
        }

        public Task<ServiceResponse<List<MenuDTO>>> GetAllMenusAsync()
        {
            throw new NotImplementedException();
        }

        public Task<ServiceResponse<MenuDTO>> GetMenuByIdAsync(Guid id)
        {
            throw new NotImplementedException();
        }

        public Task<ServiceResponse<string>> SoftDeleteMenuAsync(Guid id)
        {
            throw new NotImplementedException();
        }

        public Task<ServiceResponse<MenuDTO>> UpdateMenuAsync(MenuDTO menuDTO)
        {
            throw new NotImplementedException();
        }
